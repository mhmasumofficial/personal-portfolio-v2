...
const About = () => {
  return (
    <div
      name="about"
      id="about"
      className="w-full h-screen bg-[#0a192f] text-gray-300 mt-32 sm:mt-52 md:-mt-[500px] lg:-mt-20"
    >
        ...
        <div className="py-16 rounded-md bg-cyan-800 flex flex-col justify-center items-center w-4/6">
          ...
          <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
            <div className="sm:text-right text-4xl font-bold">
              <p>
                Hi. I'm MH Masum, nice to meet you. Please take a look around.
              </p>
            </div>
            <div>
              <p>
                ...
                web applications for clients ranging from individuals and
